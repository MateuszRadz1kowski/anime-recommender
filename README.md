...
Technologies: Next.js (frontend), Python (backend), FastAPI (communication layer between frontend and backend), GraphQL (API), Tailwind CSS (styling), shadcn/ui (UI components).
